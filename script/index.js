...
define("script/color", ["require", "exports", "resource/config"], function (require, exports, config_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (function (Color) {
        ...
        var customColoring = null;
        Color.isCustomColoring = function () {
            return null !== customColoring;
        };
        Color.setCustomColoring = function (coloring) {
        ...
        Color.getColoring = function () {
            if (Color.isCustomColoring()) {
                return customColoring;
            }
            if (Color.isRandomColoring()) {
                var index = Math.floor(Math.random() * Object.keys(config_json_1.default.coloring).length);
                var key = Object.keys(config_json_1.default.coloring)[index];
                var result = config_json_1.default.coloring[key];
                if (Color.isSameColoring(newColors, result)) {
                    index = (index + 1) % Object.keys(config_json_1.default.coloring).length;
                    key = Object.keys(config_json_1.default.coloring)[index];
                    result = config_json_1.default.coloring[key];
                }
                return result;
            }
            else {
                return config_json_1.default.coloring[Color.coloring];
            }
        };
        ...
        Color.isExpiredRandomColoring = function () {
            return Color.isRandomColoring() &&
                config_json_1.default.rendering.randomColoringUnitDuration <= (performance.now() - changedColoringAt);
        };
        ...
        var mixColor = function (oldColor, newColor, rate) {
            var boost = 1.0 + (config_json_1.default.rendering.antiDullnessBoost * Math.sin(Math.PI * rate)); // Adjustment to reduce dullness of intermediate colors
        ...
        Color.getCurrentColors = function () {
            if (Color.isCustomColoring()) {
                ...
                var span = Color.isRandomColoring() ?
                    config_json_1.default.rendering.coloringRandomFadeDuration :
                    config_json_1.default.rendering.coloringRegularFadeDuration;
...
define("script/ui", ["require", "exports", "script/url", "script/color", "resource/config"], function (require, exports, url_1, color_1, config_json_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.UI = void 0;
    ...
    (function (UI) {
        ...
        UI.WatchColorList = config_json_2.default.watch.presets;
        UI.watchColor = config_json_2.default.watch.default;
        ...
        UI.updateColoringRoundBar = function () {
            if ("custom" === coloringRoundBarIndex) {
                UI.updateRoundBar(UI.coloringButton, { low: 0, high: 0, rotate: 0, });
            }
            else {
        ...
        UI.toggleColoring = function (style) {
            ...
            if (typeof style === "boolean" || undefined === style) {
                if ("custom" === coloringRoundBarIndex) {
                    color_1.Color.coloring = "regular";
                    coloringRoundBarIndex = keys.indexOf(color_1.Color.coloring);
                    color_1.Color.setCustomColoring(null);
                }
                else {
                    var currentIndex = keys.indexOf(color_1.Color.coloring);
                    ...
                    color_1.Color.coloring = keys[nextIndex];
                ...
                if (keys.includes(style)) {
                    color_1.Color.coloring = style;
                    coloringRoundBarIndex = keys.indexOf(style);
                    color_1.Color.setCustomColoring(null);
                }
                else {
                    var coloring = style.split(" ");
                    if (3 === coloring.length) {
                        color_1.Color.coloring = "custom";
                        coloringRoundBarIndex = "custom";
                        color_1.Color.setCustomColoring({
                            base: "#" + coloring[0],
                            main: "#" + coloring[1],
                            accent: "#" + coloring[2],
                        });
            ...
            var result = "custom" === color_1.Color.coloring ?
                style :
                color_1.Color.coloring;
            url_1.Url.addParameter("coloring", result);
            console.log("\uD83C\uDFA8 Coloring changed: ".concat(result));
        };
        UI.PixelRatioModeKeys = Object.keys(config_json_2.default.quality.presets);
        var pixelRatioMode = config_json_2.default.quality.default;
        ...
        UI.getPixcelRatio = function () {
            var _a;
            var value = config_json_2.default.quality.presets[pixelRatioMode];
        ...
        var pitch = config_json_2.default.pitch.default;
        ...
        UI.updatePitchRoundBar = function () { return UI.updateRoundBar(UI.pitchButton, {
            ...
            high: config_json_2.default.pitch.presets.indexOf(pitch) / (config_json_2.default.pitch.presets.length - 1),
            rotate: 0,
        }); };
...
define("script/model", ["require", "exports", "script/random", "script/ui", "resource/config"], function (require, exports, random_js_1, ui_js_1, config_json_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (function (Model) {
        ...
        Model.Data = {
            ...
            pitch: config_json_3.default.pitch.default,
            width: 0,
            height: 0,
        ...
        Model.isOutOfCanvas = function (circle) {
            var marginRate = config_json_3.default.rendering.marginRate;
        ...
        Model.makeUnitAnimation = function () {
            var result = {
                moveAnimation: {
                    x: config_json_3.default.Layer.unit.moveAnimation.elements.map(function (i) { return Model.makeAnimation(config_json_3.default.Layer.unit.moveAnimation, i); }),
                    y: config_json_3.default.Layer.unit.moveAnimation.elements.map(function (i) { return Model.makeAnimation(config_json_3.default.Layer.unit.moveAnimation, i); }),
                },
                sizeAnimation: config_json_3.default.Layer.unit.sizeAnimation.elements.map(function (i) { return Model.makeAnimation(config_json_3.default.Layer.unit.sizeAnimation, i); }),
            };
            return result;
        };
        Model.makeUnit = function (point) {
            ...
            result.animation.appearAnimation =
                {
                    period: config_json_3.default.Layer.unit.appearAnimation.period,
                    phase: 0,
                    scale: result.scale,
                };
            return result;
        ...
        Model.makeEye = function () {
            ...
            var xRatio = 1.0;
            var yRatio = 1.0;
            var white = Model.makeCircle(point, config_json_3.default.eye.whiteRate);
            var iris = Model.makeCircle(point, config_json_3.default.eye.irisRate);
            var result = {
                white: white,
                iris: iris,
                animation: {
                    moveAnimation: {
                        x: config_json_3.default.Layer.eye.moveAnimation.elements.map(function (i) { return Model.makeAnimation(config_json_3.default.Layer.eye.moveAnimation, i * xRatio); }),
                        y: config_json_3.default.Layer.eye.moveAnimation.elements.map(function (i) { return Model.makeAnimation(config_json_3.default.Layer.eye.moveAnimation, i * yRatio); }),
                    }
                },
            };
            result.animation.appearAnimation =
                {
                    period: config_json_3.default.Layer.eye.appearAnimation.period,
                    phase: 0,
                    scale: config_json_3.default.eye.whiteRate,
                };
            return result;
        };
        var updateIris = function (eye) {
            eye.iris.x = eye.white.x + eye.white.x * (config_json_3.default.eye.whiteRate - config_json_3.default.eye.irisRate) / (1 - config_json_3.default.eye.whiteRate);
            eye.iris.y = eye.white.y + eye.white.y * (config_json_3.default.eye.whiteRate - config_json_3.default.eye.irisRate) / (1 - config_json_3.default.eye.whiteRate);
            eye.iris.radius = eye.white.radius * (config_json_3.default.eye.irisRate / config_json_3.default.eye.whiteRate);
        };
        var updateEye = function (unit, step) {
            ...
            if (unit.eye) {
                ...
                if (maxDistance < distance + config_json_3.default.eye.whiteRate) {
                    eye.white.x *= (maxDistance - config_json_3.default.eye.whiteRate) / distance;
                    eye.white.y *= (maxDistance - config_json_3.default.eye.whiteRate) / distance;
                }
                ...
                if (transion) {
                    ...
                    if (eye.animation.vanishAnimation) {
                        eye.white.radius = config_json_3.default.eye.whiteRate * (1.0 - (transion.phase / transion.period));
                        ...
                        eye.white.radius = config_json_3.default.eye.whiteRate * (transion.phase / transion.period);
                        if (transion.period <= transion.phase) {
        ...
        Model.updateUnit = function (layer, unit, step) {
            ...
            if (layer === Model.Data.main && !Model.isOutOfCanvas(unit.body)) {
                if (undefined === unit.eye && config_json_3.default.eye.appearRate <= unit.body.radius) {
                    unit.eye = Model.makeEye();
                }
            }
            if (undefined !== unit.eye && undefined === unit.eye.animation.vanishAnimation && unit.body.radius < config_json_3.default.eye.vanishRate) {
                unit.eye.animation.vanishAnimation =
                    {
                        period: config_json_3.default.Layer.eye.vanishAnimation.period,
                        phase: 0,
                ...
                if (removeUnitCooldown <= timestamp - layer.lastRemovedAt) {
                    ...
                    if (target) {
                        target.animation.vanishAnimation =
                            {
                                period: config_json_3.default.Layer.unit.vanishAnimation.period,
                                phase: 0,
                                scale: target.scale,
                            };
...
define("script/render", ["require", "exports", "script/geometry", "script/color", "script/model", "script/ui"], function (require, exports, geometry_1, color_2, model_1, ui_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (function (Render) {
        ...
        Render.draw = function (isUpdatedModel) {
            if (color_2.Color.isExpiredRandomColoring()) {
                color_2.Color.updateColoring();
            }
            var coloring = color_2.Color.getCurrentColors();
            var isColoringChanged = !color_2.Color.isSameColoring(color_2.Color.previousColors, coloring);
            if (isUpdatedModel || isColoringChanged) {
                color_2.Color.previousColors = coloring;
...
define("script/event", ["require", "exports", "script/url", "script/model", "script/color", "script/ui"], function (require, exports, url_2, model_2, color_3, ui_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Event = void 0;
    var Event;
    (function (Event) {
        Event.loadFromUrlParameters = function () {
            //console.log("URL Parameters:", Url.params);
            if (url_2.Url.get("coloring")) {
                //console.log(`🎨 Coloring from URL parameter: ${Url.params["coloring"]}`);
                ui_2.UI.toggleColoring(url_2.Url.get("coloring"));
                color_3.Color.updateColoring();
            }
            else {
                //console.log("🎨 Default coloring");
                ui_2.UI.updateColoringRoundBar();
            }
            if (ui_2.UI.PixelRatioModeKeys.includes(url_2.Url.get("quality"))) {
                //console.log(`🖼️ Quality from URL parameter: ${Url.params["quality"]}`);
                ui_2.UI.toggleQuality(url_2.Url.get("quality"));
                model_2.Model.updateStretch();
            }
            else {
                //console.log("🖼️ Default quality");
                ui_2.UI.updateQualityRoundBar();
            }
            if (url_2.Url.get("pitch") && !isNaN(Number(url_2.Url.get("pitch")))) {
                //console.log(`🎵 Pitch from URL parameter: ${Url.params["pitch"]}`);
                ui_2.UI.togglePitch(Number(url_2.Url.get("pitch")));
                model_2.Model.setPitch(ui_2.UI.getPitch());
            }
            else {
                //console.log("🎵 Default pitch");
                ui_2.UI.updatePitchRoundBar();
            }
            if (ui_2.UI.WatchColorList.includes(url_2.Url.get("watch"))) {
                //console.log(`⌚ Watch display from URL parameter: ${Url.params["watch"]}`);
                ui_2.UI.toggleWatchDisplay(url_2.Url.get("watch"));
            }
            else {
                //console.log("⌚ Default watch display");
                ui_2.UI.updateWatchVisibility();
            }
            if ("true" === url_2.Url.get("fps")) {
                //console.log("⚡ FPS display from URL parameter: true");
                ui_2.UI.toggleFpsDisplay(true);
            }
            else {
                //console.log("⚡ Default FPS display");
                ui_2.UI.fpsDiv.style.display = "none";
            }
        };
        Event.initialize = function () {
            window.addEventListener("hashchange", function () {
                url_2.Url.reloadParameters();
                Event.loadFromUrlParameters();
            });
            ...
            var commandList = [
                ...
                {
                    key: "Q",
                    button: ui_2.UI.qualityButton,
                    command: function (event) {
                        ui_2.UI.toggleQuality(!event.shiftKey);
                        model_2.Model.updateStretch();
                    }
                },
                {
                    ...
                    command: function (event) {
                        ui_2.UI.togglePitch(!event.shiftKey);
                        model_2.Model.setPitch(ui_2.UI.getPitch());
                    },
                },
                {
...
define("script/watch", ["require", "exports", "script/url", "script/ui", "script/random", "flounder.style.js/index", "resource/config"], function (require, exports, url_3, ui_3, random_1, flounder_style_js_1, config_json_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var Watch;
    (function (Watch) {
        Watch.locale = url_3.Url.get("locale") || navigator.language;
        ...
        Watch.setColor = function (color) {
            ui_3.UI.setStyle(ui_3.UI.date2, "color", color);
        ...
        Watch.update = function () {
            if ("none" !== ui_3.UI.watchColor) {
                ...
                if (ui_3.UI.isWatchStyle2()) {
                    ui_3.UI.setTextContent(ui_3.UI.yyyymmw, Watch.makeDateYyyymmw(date, Watch.locale));
                    ui_3.UI.setTextContent(ui_3.UI.dd, Watch.makeDateDd(date, Watch.locale));
                    ui_3.UI.setAttribute(ui_3.UI.date2, "datatime", datetime);
                }
                else {
                    ui_3.UI.setTextContent(ui_3.UI.date, Watch.makeDate(date, Watch.locale));
                    ui_3.UI.setAttribute(ui_3.UI.date, "datatime", datetime);
                }
                switch (ui_3.UI.getPrimaryWatchColor()) {
                    case "white":
                ...
                ui_3.UI.setTextContent(ui_3.UI.yyyymmw, "");
                ui_3.UI.setTextContent(ui_3.UI.dd, "");
                ui_3.UI.setAttribute(ui_3.UI.date2, "datatime", undefined);
...
define("script/index", ["require", "exports", "script/url", "script/model", "script/render", "script/fps", "script/ui", "script/event", "script/watch"], function (require, exports, url_4, model_3, render_1, fps_1, ui_4, event_1, watch_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    //import config from "@resource/config.json";
