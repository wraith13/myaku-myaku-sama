...
define("script/event", ["require", "exports", "script/model", "script/color", "script/ui"], function (require, exports, model_2, color_3, ui_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("script/watch", ["require", "exports", "script/url", "script/ui", "script/random", "flounder.style.js/index", "resource/config"], function (require, exports, url_2, ui_3, random_1, flounder_style_js_1, config_json_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("script/index", ["require", "exports", "script/url", "script/model", "script/color", "script/render", "script/fps", "script/ui", "script/event", "script/watch"], function (require, exports, url_3, model_3, color_4, render_1, fps_1, ui_4, event_1, watch_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    url_3.Url.initialize();
    event_1.Event.initialize();
    //console.log("URL Parameters:", Url.params);
    if (url_3.Url.params["coloring"]) {
        //console.log(`🎨 Coloring from URL parameter: ${Url.params["coloring"]}`);
        ui_4.UI.toggleColoring(url_3.Url.params["coloring"]);
        color_4.Color.updateColoring();
    }
    else {
        //console.log("🎨 Default coloring");
        ui_4.UI.updateColoringRoundBar();
    }
    if (ui_4.UI.PixelRatioModeKeys.includes(url_3.Url.params["quality"])) {
        //console.log(`🖼️ Quality from URL parameter: ${Url.params["quality"]}`);
        ui_4.UI.toggleQuality(url_3.Url.params["quality"]);
        model_3.Model.updateStretch();
    }
    else {
        //console.log("🖼️ Default quality");
        ui_4.UI.updateQualityRoundBar();
    }
    if (url_3.Url.params["pitch"] && !isNaN(Number(url_3.Url.params["pitch"]))) {
        //console.log(`🎵 Pitch from URL parameter: ${Url.params["pitch"]}`);
        ui_4.UI.togglePitch(Number(url_3.Url.params["pitch"]));
        model_3.Model.setPitch(ui_4.UI.getPitch());
    }
    else {
        //console.log("🎵 Default pitch");
        ui_4.UI.updatePitchRoundBar();
    }
    if (ui_4.UI.WatchColorList.includes(url_3.Url.params["watch"])) {
        //console.log(`⌚ Watch display from URL parameter: ${Url.params["watch"]}`);
        ui_4.UI.toggleWatchDisplay(url_3.Url.params["watch"]);
    }
    else {
