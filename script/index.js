                ...
                for (var j = i + 1; j < circles.length; j++) {
                    ...
                    if (hasFusionPath(fusionStatus)) {
                        ...
                        if (0 < wireLength) // == "wired" === fusionStatus
                         {
                            var wireLengthRate = wireLength / Math.hypot(tp1.x - tp4.x, tp1.y - tp4.y);
                            var wireWidthRate = 1 - (wireLength / (fusionLimit - wireLimit));
                            var mp0a = model_2.Model.averagePoints([model_2.Model.mulPoint(model_2.Model.averagePoints([tp1, tp4]), wireWidthRate), model_2.Model.mulPoint(cp0, 2 - wireWidthRate)]);
                            ...
                            var mp0b = model_2.Model.averagePoints([model_2.Model.mulPoint(model_2.Model.averagePoints([tp3, tp2]), wireWidthRate), model_2.Model.mulPoint(cp0, 2 - wireWidthRate)]);
